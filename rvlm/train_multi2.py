...
if __name__=="__main__":
    ...
    save_dir += "_CLwTextLoRA_freezeproj_mpm"
    # save_dir += "_CLwTextLoRA_loraproj"
    ...
    if args.lambda_feat_ortho > 0. :
        ...
        # loralib.apply_lora(model, num_lora, args.r, args.lora_alpha, args.lora_dropout, lora_modules, ortho_feat_loss_fn, gating=args.gating, lora_intermediate=args.lora_intermediate, visual_only=False, proj=True)
    else:
        ...
        # loralib.apply_lora(model, num_lora, args.r, args.lora_alpha, args.lora_dropout, lora_modules, gating=args.gating, lora_intermediate=args.lora_intermediate, visual_only=False, proj=True)
    # loralib.set_used_lora(model, lora_idxs)
    loralib.set_used_lora(model, lora_idxs, visual_only=False)
    # loralib.set_used_lora(model, lora_idxs, visual_only=False, proj=True)
